...
tune_sample_size = min(50000, len(X_train_scaled))
X_tune = X_train_scaled.sample(n=tune_sample_size, random_state=42)
...
search = RandomizedSearchCV(
    estimator=CatBoostRegressor(verbose=0, random_state=42, loss_function="RMSE"),
...
# Save trained model and preprocessing objects for reuse
best_model.save_model("catboost_model.cbm")
joblib.dump(scaler, "scaler.pkl")
joblib.dump(X_train_scaled.columns.tolist(), "feature_columns.pkl")
print("Saved: catboost_model.cbm, scaler.pkl, feature_columns.pkl")
