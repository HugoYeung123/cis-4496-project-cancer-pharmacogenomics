...
# Clean categorical columns: cast to string, fill any residual missing
...
# Scaler is fit on training data only — no data leakage. Only continuous numeric columns are scaled; OHE columns are left unchanged.
